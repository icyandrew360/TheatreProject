...
public class SearchResults extends javax.swing.JFrame {
     ...
     * @param registered
     */
    public SearchResults(int movieID, boolean registered) {
    ...
    private void initComponents() {
        ...
        subject480Label.setIcon(new javax.swing.ImageIcon("C:\\Users\\Jenna Vlaar\\Desktop\\Images\\subject480.png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchResults(movieID, registered).setVisible(true);
            }
        });
    }
